...
class SqsCustomModal extends HTMLElement {
    ...
    getPropsValues() {
        ...
        if (alignItems) modalContent.style.alignItems = alignItems;
        if (justifyContent) modalContent.style.justifyContent = justifyContent;
        if (flexDirection) modalContent.style.flexDirection = flexDirection;
    }
    connectedCallback() {
        this.getPropsValues();
